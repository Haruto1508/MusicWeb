...
public class RefreshServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
         // Xóa cache cũ và load lại dữ liệu mới
        getServletContext().removeAttribute("guitars");
        getServletContext().removeAttribute("pianos");
        getServletContext().removeAttribute("violins");
