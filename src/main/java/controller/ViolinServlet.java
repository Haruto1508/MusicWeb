 ...
 */
@WebServlet(name="ViolinServlet", urlPatterns={"/violin"})
public class ViolinServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViolinServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViolinServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        int categoryId = CategoryType.CATEGORY_VIOLIN;
        ...
        // Gửi dữ liệu tới JSP
        request.setAttribute("violins", products);
