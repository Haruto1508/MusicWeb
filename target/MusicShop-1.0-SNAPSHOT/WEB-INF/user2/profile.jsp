                ...
                <div class="col-md-8">
                    <c:choose>
                        <c:when test="${param.view == 'info' or empty param.view}">
                            <jsp:include page="/WEB-INF/user2/info.jsp" />
                        </c:when>
                        <c:when test="${param.view == 'cart'}">
                            <jsp:include page="/WEB-INF/user2/cart.jsp" />
                        </c:when>
                        <c:when test="${param.view == 'order'}">
                            <jsp:include page="/WEB-INF/user2/order.jsp" />
                        </c:when>
                        <c:when test="${param.view == 'setting'}">
                            <jsp:include page="/WEB-INF/user2/setting.jsp" />
                        </c:when>
                    </c:choose>
                </div>
            </div>
