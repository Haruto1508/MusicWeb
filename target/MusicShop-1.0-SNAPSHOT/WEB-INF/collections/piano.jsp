            ...
            <form>
                ...
                <div style="margin-bottom:18px;">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="grand" name="type" value="brand" <c:if test="${selectedTypes != null && fn:contains(fn:join(selectedTypes, ','), 'brand')}">checked</c:if>>
