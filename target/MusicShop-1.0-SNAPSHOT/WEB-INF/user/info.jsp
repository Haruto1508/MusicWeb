            ...
            <div class="card-body">
                <form id="userForm" action="${pageContext.request.contextPath}/account" method="post">
                    ...
                    <div class="text-center">
                        <button type="button" class="btn btn-primary" id="editBtn"><i class="fas fa-edit"></i> Edit</button>
                        <button type="submit" class="btn btn-success d-none" id="saveBtn"><i class="fas fa-save"></i> Save</button>
